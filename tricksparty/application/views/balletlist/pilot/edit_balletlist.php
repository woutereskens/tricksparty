...
<?php echo form_open('Balletlist/editBalletlist', array('role' => 'form')); ?>
<div class="row">
    <div class="col-md-6">
                ...
                foreach ($balletlistsA as $balletlistA) {
                    ...
                    <tr>
                        <td class="text-center">
                            <label for="A<?php echo $balletlistA->ScoreType; ?>"><?php echo $counter; ?></label>
                        </td>
                        <td class="text-center">
                            <select name="A<?php echo $balletlistA->ScoreType; ?>" id="A<?php echo $balletlistA->ScoreType; ?>" class="js-example-basic-single form-control" style="width: 100%">
                                <?php foreach ($trickgroups as $trickgroup) { ?>
                                    <optgroup label="<?php echo $this->lang->line("group") . ' ' . $trickgroup->TrickGroup; ?>">
                                        <?php foreach ($trickgroup->Tricks as $trick) { ?>
                                            <option value="<?php echo $trick->Trick; ?>" <?php echo set_select('A' . $balletlistA->ScoreType, $trick->Trick, $trick->Trick == $balletlistA->Trick); ?>><?php echo $trick->Trick; ?></option>
                                        <?php } ?>
                                    </optgroup>
                                <?php } ?>
                            </select>
        ...
        <div class="table-responsive">
            <table class="table">
                ...
                foreach ($balletlistsB as $balletlistB) {
                    ...
                    <tr>
                        <td class="text-center">
                            <label for="B<?php echo $balletlistB->ScoreType; ?>"><?php echo $counter; ?></label>
                        </td>

                        <td class="text-center">
                            <select name="B<?php echo $balletlistB->ScoreType; ?>" id="B<?php echo $balletlistB->ScoreType; ?>" class="js-example-basic-single form-control" style="width: 100%">
                                <?php foreach ($trickgroups as $trickgroup) { ?>
                                    <optgroup label="<?php echo $this->lang->line("group") . ' ' . $trickgroup->TrickGroup; ?>">
                                        <?php foreach ($trickgroup->Tricks as $trick) { ?>
                                            <option value="<?php echo $trick->Trick; ?>" <?php echo set_select('B' . $balletlistB->ScoreType, $trick->Trick, $trick->Trick == $balletlistB->Trick); ?>><?php echo $trick->Trick; ?></option>
                                        <?php } ?>
                                    </optgroup>
                                <?php } ?>
                            </select>
